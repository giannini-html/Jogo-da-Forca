...
const categorias = {
    frutas: ["abacaxi", "limão", "laranja", "mamao", "uva", "melancia", "melao"],
    profissoes: ["engenheiro", "advogado", "medico", "professor", "desenvolvedor", "analista"],
...
function ocultaPalavra(){
    ...
    exibePalvraInterface(palavraOcultada);
}

function exibePalvraInterface(palavra){
...
function atualizaPalavraInterface(letra){
    ...
    exibePalvraInterface(palavraAux);
}
